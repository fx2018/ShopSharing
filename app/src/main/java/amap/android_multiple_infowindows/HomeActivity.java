...
public class HomeActivity extends AppCompatActivity
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textview_mine = null; //(TextView) findViewById(R.id.textView1);
        rg_mainBottom = null; //(RadioGroup) findViewById(R.id.radioGroupMainBottom);
        rb_mainBottom_mine = null; //(RadioButton) findViewById(R.id.radio_mine);
        rb_mainBottom_find = null;//(RadioButton) findViewById(R.id.radio_find);
